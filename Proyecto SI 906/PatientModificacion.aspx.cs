...
{
    public partial class PatientModificacion : System.Web.UI.Page
    {
        SqlConnection conn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void subbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string insertuser = "Update Pacientes set PRIMER_APELLIDO = @pPrimerApellido, SEGUNDO_APELLIDO=@pSegundoApellido,"
                    + "NOMBRE=@pnombre,FECNAC=@pfecnac, EDONAC=@pedonac, SEXO=@psexo, NACORIGEN=@pnacorigen, FOLIO=@pfolio," +
                    " EDO=@pedo, MUN=@pmun, LOC=@ploc, TIPO_BENEFICIARIO=@pTipoBeneficiario, CLAVE_DEPEDENCIA=@pClaveDependencia," +
                    " CLAVE_PROGRAMA=@pClavePrograma where CURP=@pcurp";
