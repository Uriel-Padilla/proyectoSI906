<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="PatientModificacion.aspx.cs" Inherits="Proyecto_SI_906.PatientModificacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="z-index: 102; left: 104px; font-family: 'Lucida Console'; position: absolute; top: 190px">
        ...
        <tr>
            ...
            <td style="width: 100px">
                <asp:Button ID="subbtn" runat="server" Text="Modificar" Width="94px" OnClick="subbtn_Click" />
            </td>
            <td style="width: 100px">
                <asp:Button ID="Button2" runat="server" Text="Limpiar" OnClick="Button2_Click"/></td>
        </tr>
    </table>
    <asp:Label ID="Label1" runat="server" Font-Names="Arial Black" Font-Size="24pt" ForeColor="Black" Text="Modificación de pacientes" Font-Bold="True" CssClass="auto-style5"></asp:Label>
</asp:Content>
